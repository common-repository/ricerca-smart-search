...
class Customize{
    ...
    public function __construct(){
        ...
        \add_filter('ric_def_options', function($opt){
            if(empty($opt['customize']['customize_active'])){
                $opt['customize']['customize_active']='no';
            }
            return $opt;
        });
        ...
        \add_filter('ric_settings_fields_array', function($fields){
            ...
            $f=[];
            $f['key'] = 'customize_layoutbg';
            $f['def'] = '#ffffff';
            $f['type'] = 'color';
            $f['subtype'] = 'none';
            $f['label'] = __('Layout background color','ric');
            $f['label_row_after'] = '';
            $fields['customize'][]=$f;


            $f=[];
            $f['key'] = 'customize_title_googlefont';
            $f['def'] = '-1';
            $f['type'] = 'select';
            $f['subtype'] = 'none';

            $f['options'] = [];
            $f['options']['-1'] = 'System default';
            if(!empty(self::getGoogleFonts())){
                foreach(self::getGoogleFonts() as $gfn){
                    $f['options'][$gfn]=$gfn;
                }
            } 
            $f['label'] = esc_html__('Font family - google font','ric');
            $f['label_row_after'] = '';
            $f['label_row_after_pro'] = sprintf( esc_html__('Wanna use custom font? %s and improve typography today.', 'ric' ), '<a href="https://my.myricerca.com/downloads/pro/" target="blank">'.esc_html__("Upgrade to Premium",'ric').'</a>');
            $f['ispro'] = true;
            ...
            $f=[];
            $f['key'] = 'customize_title_fontweight';
            $f['def'] = '700';
            $f['type'] = 'select';
            $f['subtype'] = 'none';
            $f['options'] = [
            ...
            $f['label'] = esc_html__('Titles font weight','ric');
            $f['label_row_after'] = '';
            $f['label_row_after_pro'] = sprintf( esc_html__('Wanna be free to play with it? %s and start customize today.', 'ric' ), '<a href="https://my.myricerca.com/downloads/pro/" target="blank">'.esc_html__("Upgrade to Premium",'ric').'</a>');
            $f['ispro'] = true;
            ...
            $f=[];
            $f['key'] = 'customize_title_fontsize';
            $f['def'] = 16;
            $f['type'] = 'unit';
            $f['label'] = esc_html__('Titles font size','ric');
            $f['label_row_after'] = ''; 
            $f['ispro'] = true;
            $f['label_row_after_pro'] = sprintf( esc_html__('Wanna be free to play with it? %s and start customize today.', 'ric' ), '<a href="https://my.myricerca.com/downloads/pro/" target="blank">'.esc_html__("Upgrade to Premium",'ric').'</a>');
            $fields['customize'][]=$f;
            ...
            $f=[];
            $f['key'] = 'customize_subtitle_fontsize';
            $f['def'] = 16;
            $f['type'] = 'unit';
            $f['label'] = esc_html__('Sub titles font size','ric');
            $f['label_row_after'] = ''; 
            $f['ispro'] = true;
            $f['label_row_after_pro'] = sprintf( esc_html__('Wanna be free to play with it? %s and start customize today.', 'ric' ), '<a href="https://my.myricerca.com/downloads/pro/" target="blank">'.esc_html__("Upgrade to Premium",'ric').'</a>');
            $fields['customize'][]=$f;
            ...
            $f=[];
            $f['key'] = 'customize_addcartbutton_fontsize';
            $f['def'] = 10;
            $f['type'] = 'unit';
            $f['label'] = esc_html__('Add to cart button font size','ric');
            $f['label_row_after'] = ''; 
            $f['ispro'] = true;
            $f['label_row_after_pro'] = sprintf( esc_html__('Wanna be free to play with it? %s and start customize today.', 'ric' ), '<a href="https://my.myricerca.com/downloads/pro/" target="blank">'.esc_html__("Upgrade to Premium",'ric').'</a>');
            $fields['customize'][]=$f;
            ...
            $f=[];
            $f['key'] = 'customize_prom_fontsize';
            $f['def'] = 10;
            $f['type'] = 'unit';
            $f['label'] = esc_html__('Promotions titles font size','ric');
            $f['label_row_after'] = ''; 
            $f['ispro'] = true;
            $f['label_row_after_pro'] = sprintf( esc_html__('Wanna be free to play with it? %s and start customize today.', 'ric' ), '<a href="https://my.myricerca.com/downloads/pro/" target="blank">'.esc_html__("Upgrade to Premium",'ric').'</a>');
            $fields['customize'][]=$f;
            ...
            $f=[];
            $f['key'] = 'customize_title';
            $f['def'] = '#000000';
            $f['type'] = 'color';
            $f['subtype'] = 'none';
            $f['label'] = __('Color of titles','ric');
            $f['label_row_after'] = '';
            $f['label_row_after'] = '';
            $f['label_row_after_pro'] = sprintf( esc_html__('Wanna be free to play with it? %s and start customize today.', 'ric' ), '<a href="https://my.myricerca.com/downloads/pro/" target="blank">'.esc_html__("Upgrade to Premium",'ric').'</a>');
            $f['ispro'] = true;
            ...
            $f=[];
            $f['key'] = 'customize_subtitle';
            $f['def'] = '#000000';
            $f['type'] = 'color';
            $f['subtype'] = 'none';
            $f['label'] = __('Color of subtitles','ric');
            $f['label_row_after'] = '';
            $f['label_row_after'] = '';
            $f['label_row_after_pro'] = sprintf( esc_html__('Wanna be free to play with it? %s and start customize today.', 'ric' ), '<a href="https://my.myricerca.com/downloads/pro/" target="blank">'.esc_html__("Upgrade to Premium",'ric').'</a>');
            $f['ispro'] = true;
            ...
            $f=[];
            $f['key'] = 'customize_addtocart';
            $f['def'] = '#ffffff';
            $f['type'] = 'color';
            $f['subtype'] = 'none';
            $f['label'] = __('Add to cart font collor','ric');
            $f['label_row_after'] = '';
            $f['label_row_after'] = '';
            $f['label_row_after_pro'] = sprintf( esc_html__('Wanna be free to play with it? %s and start customize today.', 'ric' ), '<a href="https://my.myricerca.com/downloads/pro/" target="blank">'.esc_html__("Upgrade to Premium",'ric').'</a>');
            $f['ispro'] = true;
            ...
            $f=[];
            $f['key'] = 'customize_addtocartbg';
            $f['def'] = '#7c7235';
            $f['type'] = 'color';
            $f['subtype'] = 'none';
            $f['label'] = __('Add to cart backgound','ric');
            $f['label_row_after'] = '';
            $f['label_row_after'] = '';
            $f['label_row_after_pro'] = sprintf( esc_html__('Wanna be free to play with it? %s and start customize today.', 'ric' ), '<a href="https://my.myricerca.com/downloads/pro/" target="blank">'.esc_html__("Upgrade to Premium",'ric').'</a>');
            $f['ispro'] = true;
            ...
            $f=[];
            $f['key'] = 'customize_color';
            $f['def'] = '#7c7235';
            $f['type'] = 'color';
            $f['subtype'] = 'none';
            $f['label'] = __('Close icon color','ric');
            $f['label_row_after'] = '';
            $f['label_row_after'] = '';
            $f['label_row_after_pro'] = sprintf( esc_html__('Wanna be free to play with it? %s and start customize today.', 'ric' ), '<a href="https://my.myricerca.com/downloads/pro/" target="blank">'.esc_html__("Upgrade to Premium",'ric').'</a>');
            $f['ispro'] = true;
            ...
            $f=[];
            $f['key'] = 'customize_prom_title';
            $f['def'] = '#000000';
            $f['type'] = 'color';
            $f['subtype'] = 'none';
            $f['label'] = __('Promotions color of titles','ric');
            $f['label_row_after'] = '';
            $f['label_row_after'] = '';
            $f['label_row_after_pro'] = sprintf( esc_html__('Wanna be free to play with it? %s and start customize today.', 'ric' ), '<a href="https://my.myricerca.com/downloads/pro/" target="blank">'.esc_html__("Upgrade to Premium",'ric').'</a>');
            $f['ispro'] = true;
            ...
            $f=[];
            $f['key'] = 'customize_termscorrector_fontsize';
            $f['def'] = 16;
            $f['type'] = 'unit';
            $f['label'] = esc_html__('Terms Corrector font size','ric');
            $f['label_row_after'] = ''; 
            $f['ispro'] = true;
            $f['label_row_after_pro'] = sprintf( esc_html__('Wanna be free to play with it? %s and start customize today.', 'ric' ), '<a href="https://my.myricerca.com/downloads/pro/" target="blank">'.esc_html__("Upgrade to Premium",'ric').'</a>');
            $fields['customize'][]=$f;
            ...
            $f=[];
            $f['key'] = 'customize_termscorrector_color';
            $f['def'] = '#000000';
            $f['type'] = 'color';
            $f['subtype'] = 'none';
            $f['label'] = __('Color of Terms Corrector','ric');
            $f['label_row_after'] = '';
            $f['label_row_after'] = '';
            $f['label_row_after_pro'] = sprintf( esc_html__('Wanna be free to play with it? %s and start customize today.', 'ric' ), '<a href="https://my.myricerca.com/downloads/pro/" target="blank">'.esc_html__("Upgrade to Premium",'ric').'</a>');
            $f['ispro'] = true;
        ...
        \add_action('ric_footer_html', function(){


            $settings = \Ric\Func::getOption('customize');
            if(!empty($settings) && $settings['customize_active']=='yes'){
                $roles= [];
                if(!empty($settings['customize_layoutbg'])){
                    $roles[] = '.ric_collection_layer, .ric_modal{ background-color: '.$settings['customize_layoutbg'].' !important; } ';
                }
